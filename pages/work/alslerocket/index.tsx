...
export default function Page() {
    ...
    useEffect(() => {
        const found = projects.find(project => project.name === "ALSLE ROCKET");
        setProject(found)
    }, [])
    ...
    return (
        <>
            <div className="flex flex-col items-start  p-3 w-full sm:w-9/12 m-auto relative">
                ...
                <LinkComponent link={"https://www.aislerocket.com"} name={"Visit"} backgroundColor={project?.buttonColor} />
                        ...
                        <div className="row">
                            {project?.workImages.map((project, index) => (
                                <motion.div
                                    ...
                                    <img src={project} className="object-contain"></img>
                                </motion.div>
                            ))}
                        </div>
                    </div>
