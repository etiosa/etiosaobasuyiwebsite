...
export default function Page() {
    ...
    useEffect(() => {
        const found = projects.find(project => project.name === "AUROX");
        setProject(found)
    }, [])
    return (
        <>
            <div className="flex flex-col items-start  p-3 w-full sm:w-9/12 m-auto relative">
                ...
                <div className="grid mt-14  sm:mt-0 justify-evenly   grid-cols-2 md:grid-cols-3  gap-14 sm:gap-24">
                    <motion.div
                    ...
                    <motion.div
                        ...
                        <h5 className=" top-5 text-md whitespace-nowrap">
                            {project?.year}
                        </h5>
                    </motion.div>
                    <motion.div
                        ...
                        <div className=" relative grid grid-cols-12  md:grid-cols-4   gap-16  text-md whitespace-nowrap">
                            <span>Next JS</span>
                            <span>Redux</span>
                            <span>React</span>
                ...
                <div className="max-[1200px]:hidden">
                    ...
                    <div className="flex justify-center mt-14  w-6/12">
                        <motion.div
                            ...
                            className="flex  items-center mr-24 cursor-pointer" onClick={pre} >
                            <motion.svg
                                xmlns="http://www.w3.org/2000/svg" fill={project?.buttonColor} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"
                                className="w-10 h-10  ">
                        ...
                        <motion.div
                            ...
                            onClick={next} className="flex items-center cursor-pointer">
                            <span >Next</span>
                        ...
                        <div className="row">
                            {project?.workImages.map((project, index) => (
                                <motion.div
                                    ...
                                    <img alt="Aurox" src={project} className="object-contain"></img>
                                </motion.div>
                            ))}
                        </div>
                    </div>
